...
halo.use(function(m){
	halo.add('wglogin',function(){
		...
		var status=function(){
			var _isLogin=(getCookie("wg_skey") && getCookie("wg_uin") || getCookie("p_skey") && getCookie("p_uin") || getCookie("skey") && getCookie("uin"))?true:false;
		...
		var wxlogin=function(){
			...
			window.location.href = 'http://party.wanggou.com/tws64/m/wxv2/Login?appid=1&rurl=' + encodeURIComponent(ru);
		};
		//以下是拍拍登录
